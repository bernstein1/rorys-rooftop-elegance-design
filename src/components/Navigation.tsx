          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className={`text-lg text-foreground/90 hover:text-primary font-medium font-didot transition-colors px-3 py-1 ${
          ...
          <div className="px-3 pt-2 pb-4 space-y-1 sm:px-3 bg-background border-b border-border">
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className="block text-lg font-medium font-didot px-3 py-2 rounded-md text-foreground/90 hover:bg-primary/10 hover:text-primary transition-colors"
