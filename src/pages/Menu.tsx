...
const MENU_DATA = {
  ...
  "Signature Entrees": [
    ...
    { name: "Creamy Cajun Alfredo", description: "Choice of Chicken or Shrimp, or add Steak (+$5). Cajun alfredo, penne pasta, manchego, black pepper", price: "$24" },
    { name: "Huli Huli Chicken Skewers", description: "Chicken skewers, pineapple fried rice, coconut cream sauce", price: "$24" },
    { name: "Stuffed Chicken Marsala", description: "Sun dried tomato stuffed chicken, mozzarella, mashed potatoes, green beans, house marsala sauce", price: "$24" },
  ...
  "Taca-Nadas": [
    { name: "Carne Asada Taca-Nadas", description: "Deep fried & stuffed empanada shells. Pico de gallo, lettuce, poblano aioli, cotija, lime wedge", price: "$18" },
    { name: "Ancho Chicken Taca-Nadas", description: "Deep fried & stuffed empanada shells. Pico de gallo, lettuce, poblano aioli, cotija, lime wedge", price: "$18" },
    { name: "Impossible™ Beef Taca-Nadas", description: "Deep fried & stuffed empanada shells. Pico de gallo, lettuce, nacho 'cheese' sauce, lime wedge", price: "$18" },
  ],
  "Handhelds": [
    { name: "Double Smash Burger", description: "Served with house cut fries. Double smash patty, house sauce, pickle, American cheese, lettuce, tomato. Add guacamole (+$2), bacon (+$2), caramelized onions (+$2)", price: "$24" },
    { name: "Fried Chicken Sandwich", description: "Served with house cut fries. Buttermilk fried chicken, slaw, garlic aioli. Add guacamole (+$2), cheddar (+$2)", price: "$24" },
    { name: "Meatless Fried Chicken Sandwich", description: "Meatless fried chicken, vegan cheese, lettuce, tomato, pickles, vegan house sauce, gluten free burger bun", price: "$22" },
    { name: "Miso Salmon Roll", description: "Choice of homemade Old Bay chips or fries. Toasted brioche bun, apple slaw, gochujang aioli", price: "$23" },
  ],
  "Salads": [
  ...
  "Sweet Treats": [
    ...
    { name: "Seasonal Crème Brulee", description: "Mango crème brulee, fresh fruit, mint", price: "$12" },
  ],
  "Rory's Beachside Cocktails": [
    ...
    { name: "Sangria", description: "Red blend, apple brandy, house made grenadine, cinnamon, orange, mint", price: "$17" },
    { name: "Rooftop Margarita", description: "Blanco tequila, cucumber, lime, cane sugar", price: "$17" },
  ],
  "Bounties": [
    { name: "Bounty Cocktails", description: "Available by the glass ($19), carafe for 2 ($32), or bowl for 4 ($64). Choose from any of our signature cocktails above.", price: "From $19" },
  ],
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-20">
            ...
            <div className="mt-6 text-sm text-muted-foreground space-y-2">
              <p>A 20% gratuity will be added to parties of 6 or more.</p>
