...
// Enhanced blog posts with SEO-optimized content
const POSTS = [
  {
    ...
    keywords: ["rooftop bars NYC", "Meatpacking District nightlife", "Manhattan rooftop", "NYC cocktail bars", "sunset drinks NYC"],
    content: `
  ...
  },
  {
    ...
    keywords: ["romantic restaurants NYC", "date night NYC", "rooftop dining Manhattan", "romantic rooftop bars", "NYC dinner dates"],
    content: `
  ...
  },
  {
    ...
    keywords: ["happy hour NYC", "after work drinks", "Meatpacking District bars", "professional networking NYC", "cocktail hour Manhattan"],
    content: `
  ...
  },
  {
    ...
    keywords: ["group events NYC", "rooftop party venues", "birthday parties Manhattan", "corporate events NYC", "bachelorette parties NYC"],
    content: `
    ...
    <div className="min-h-screen pt-0 pb-16 bg-background">
      ...
      <section className="max-w-6xl mx-auto px-4 pt-32">
        ...
        <p className="text-lg md:text-xl mb-8 text-muted-foreground text-center max-w-2xl mx-auto">
          Your guide to NYC's elevated dining scene, craft cocktails, and rooftop culture in the heart of Manhattan's Meatpacking District.
        </p>
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground text-base">
            Looking for more NYC rooftop insights? <a href="/contact" className="underline text-primary">Contact us</a> for custom content or collaboration opportunities.
          </p>
        </div>
      </section>
    </div>
